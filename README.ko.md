...
![AWS 아키텍처](assets/paper-bridge-architecture.drawio.png)

### 데이터 흐름

![데이터 흐름](assets/paper-bridge-dataflow.drawio.png)

> **더 자세히:** 모든 모듈·설정 필드·설계 결정을 줄 단위로 다룬 기술 문서는 [`assets/tech-doc.md`](assets/tech-doc.md)에 있습니다.
...
CI는 GitHub Actions에서 돌아갑니다 — 린트, 포맷, 타입 검사, 테스트 + 커버리지, Docker 빌드, `terraform validate`, 보안 스캔. [`.github/workflows/ci.yml`](.github/workflows/ci.yml)을 참고하세요. 빌드 / 배포 / 설정에 관한 자세한 내용은 [`assets/tech-doc.md`](assets/tech-doc.md)(§11–§12)에 있습니다.
