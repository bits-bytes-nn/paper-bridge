...
![Paper Bridge AWS 아키텍처](../assets/paper-bridge-architecture.drawio.png)

**워크플로**

![Paper Bridge 워크플로](../assets/paper-bridge-workflow.png)

**파이프라인**

![Paper Bridge 파이프라인](../assets/paper-bridge-pipeline.png)
...
![Paper Bridge 데이터 흐름](../assets/paper-bridge-dataflow.drawio.png)
